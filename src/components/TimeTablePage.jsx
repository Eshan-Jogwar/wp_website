...
const TimeTablePage = () => {
  ...
  const toggleEditing = () => {
    if (editing) {
      ...
      fetch("http://localhost:5000/api/updateTimeTable", {
        method: "POST",
        headers: {
      ...
      <div className="content">
            ...
            {[
              ...
              <tr key={rowIdx}>
                ...
                {timetable[rowIdx]?.length === 1 ? (
                  <td colSpan="5" className="lunch-cell">{timetable[rowIdx][0]}</td>
                ) : (
        ...
        <div className="legend-box">
          <ul className="legend-list">
            <li className="legend-item"><strong>AE :</strong> Applied Electronics</li>
            <li className="legend-item"><strong>IE :</strong> Introduction to Entrepreneurship</li>
            <li className="legend-item"><strong>DS :</strong> Data Structures</li>
            <li className="legend-item"><strong>ILA :</strong> Introduction to Linear Algebra</li>
            <li className="legend-item"><strong>PS :</strong> Probability and Statistics</li>
            <li className="legend-item"><strong>WP :</strong> Web Programming</li>
          </ul>
        </div>
      </div>
    </div>
